...
export const managerSidebar = [
  ...
  { id: 2, title: "Receptionists", link: "/manager-dashboard/receptionists", icon: faUser },
...
export const receptionistSidebar = [
  ...
  { id: 2, title: "Rooms", link: "/receptionist-dashboard/rooms", icon: faBuilding },
  { id: 3, title: "Reservations", link: "/receptionist-dashboard/reservations", icon: faCalendarCheck },
  { id: 4, title: "Reports", link: "/receptionist-dashboard/reports", icon: faClipboardList },
  { id: 5, title: "Activity Logs", link: "/receptionist-dashboard/logs", icon: faClockRotateLeft },
];