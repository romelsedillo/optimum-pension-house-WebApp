...
export const reservationCollectionSales = async () => {
  try {
    ...
    const data = response.documents
      ...
      .map((doc) => ({
        ...
        guestAddress: doc?.guests?.address,
        guestPhone: doc?.guests?.phone,
        guestEmail: doc?.guests?.email,
        room: `room ${doc?.rooms?.roomNumber} : ${doc?.rooms?.roomType?.typeName}`,
        roomRate: doc?.rooms?.roomType?.rate,
...
export default reservationCollectionSales;
