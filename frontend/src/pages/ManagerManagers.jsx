...
import ManagerTable from "../components/Tables/ManagerTable/ManagerTable";
      ...
      <div className="w-full flex flex-col h-screen overflow-y-auto">
        ...
        <div className="p-4 flex flex-col gap-4">
          <div className="w-full py-1  flex justify-between px-16">
            <p className="text-[#0070F0] text-3xl">Managers</p>
            <Breadcrumb dashboard="Dashboard" path="Manager" />
          </div>
